## 👟 안녕하세요! 안드로이드 개발자 조익성입니다.

- 엔드유저와 직접 상호작용하며 기술로 불편함을 해결할 수 있는 점에서 앱 개발에 흥미를 느끼게 되었고, 안드로이드의 넓은 생태계와 다양한 기술을 접하며 지속적으로 성장할 수 있다는 점에 끌려 안드로이드 개발자를 선택하게 되었습니다.
- 작업을 할 때, **그냥**이 아닌 **왜**에 집중해 이유를 가지고 행동하기 위해 노력합니다.
